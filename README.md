# EDS 220: Homework 4 - Visualizing Wildfires Scars with Remote Sensing
...
.
├── data
│   ├── California_Historic_Fire_Perimeters_-5643920427189821347.geojson
│   └── landsat8-2025-02-23-palisades-eaton.nc
├── hwk4-task2-false-color-LOO.ipynb
├── README.md
```

## About

This repository contains materials for EDS 220 Homework 4. The notebook `hwk4-task2-false-color-LOO.ipynb` contains the analysis that uses false-color imagery to show the effects of the 2025 Palisades-Eaton fire in California, USA.
